...
class AboutBlocks < Neo::Koan
  ...
  def test_blocks_can_take_arguments
    method_with_block_arguments do |argument| #why is this written this way?
      assert_equal "Jim", argument #why is this "Jim"?
    end
  end
  ...
  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    ...
    result = method_with_block_arguments(&make_upper) #why is the parameter written that way?
