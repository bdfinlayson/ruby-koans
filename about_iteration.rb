...
class AboutIteration < Neo::Koan
  ...
  ## My Answer: when you use the File.open(filename) do |file| construct, you have access to "file" right away for manipulation, whereas in the latter construct this is happening later after the file is set to the instance. 
end
